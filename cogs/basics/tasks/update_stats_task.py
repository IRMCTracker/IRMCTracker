...
class StatsTask(Cog):
    ...
    async def update_members_count(self):
        ...
        await channel.edit(
            name=f"👥・ Members「{humanize_number(guild.member_count, True)}」"
        )
